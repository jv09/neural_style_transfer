...
Original file is located at
    https://colab.research.google.com/drive/1aStrjPmGbuE-83snMfrdHd46PN6zdKqZ
...
if __name__ == '__main__':
	...
	content_img = load_img('/content/drive/MyDrive/Colab Notebooks/content_images/los_angeles.jpg', 512).to(device)
	style_img = load_img('/content/drive/MyDrive/Colab Notebooks/style_images/starry_night_full.jpg', 512).to(device)
